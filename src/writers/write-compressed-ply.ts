...
const writeCompressedPly = async (sink: DataSink, dataTable: DataTable) => {
    ...
    await sink.write(new Uint8Array(chunkData.buffer));
    await sink.write(new Uint8Array(splatIData.buffer));
    await sink.write(shData);
};
